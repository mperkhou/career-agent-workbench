...
full-depth offline Career Agent Workbench demonstration. Tessa Rowan, every
organization, location, date, credential, project, and job opening is
fictionalized for public use, and all URLs use reserved example domains.
